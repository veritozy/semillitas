          ...
          <div className="flex items-center justify-between py-3 h-20">
            ...
            <div className="hidden lg:flex items-center gap-10">
              <ul className="flex items-center gap-8 list-none p-0 m-0">
                <li>
                  <a href="/nosotros" className="text-[#09667e] font-extrabold hover:text-[#0094d3] no-underline text-[14px] tracking-[0.15em] transition-all uppercase">
                    Quiénes Somos
                  </a>
                </li>
                ...
                >
                  <button className="flex items-center gap-1 text-[#09667e] font-extrabold hover:text-[#0094d3] bg-transparent border-none cursor-pointer transition-all uppercase text-[14px] tracking-[0.15em]">
                ...
                <li>
                  <a href="/noticias" className="text-[#09667e] font-extrabold hover:text-[#0094d3] no-underline uppercase text-[14px] tracking-[0.15em] transition-all">
                    Noti Blog
                  </a>
                </li>
              </ul>
