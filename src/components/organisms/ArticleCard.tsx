    ...
    <div className="group h-[400px] w-full [perspective:1000px]">
      <div className="relative h-full w-full rounded-2xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        ...
        <div className="absolute inset-0">
          ...
          />
          {/* Overlay oscuro para que el título frontal siempre se lea */}
        ...
        {/* PARTE TRASERA: Descripción sobre fondo sólido */}
        <div className="absolute inset-0 h-full w-full rounded-2xl bg-[#09667e] p-8 text-center text-white [transform:rotateY(180deg)] [backface-visibility:hidden]">
