      ...
      <div className="container px-6 py-16 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-blue-500 opacity-30" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center justify-center mt-8">
            <div className="mt-4 text-center">
              ...
              <span className="text-sm text-blue-500 uppercase tracking-widest font-bold">Lanzamiento del Pacto Educativo Global</span>
            </div>
          </div>
        </div>
      </div>
