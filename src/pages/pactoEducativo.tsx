...
import FrasePeg from "../components/frasePeg";
import NoticiasPeg from "../components/noticiasPeg";
import SectionPe from "../components/sectionPactoEducativo";
...
export default function PactoEducativoGlobal() {
  return (
    <>
     <SectionPe/>
     {}
